...
var App = () => {
  var _a, _b, _c;
  const validationSchema = create6().shape({
    wifeFirstName: create3().required("Fullname is required"),
    wifeLastName: create3().required("Fullname is required"),
    wifeEmail: create3().required("Email is required").email("Email is invalid")
  });
  const {
    register,
    handleSubmit,
...
//# sourceMappingURL=/build/routes/register-KGKWY2RU.js.map
