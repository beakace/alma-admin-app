...
var useGridColumnHeaders = (props) => {
  ...
  const getColumnHeaders = (params, other = {}) => {
    ...
    for (let i = 0; i < renderedColumns.length; i += 1) {
      ...
      columns.push(/* @__PURE__ */ (0, import_jsx_runtime149.jsx)(GridColumnHeaderItem, _extends({}, sortColumnLookup[column.field], {
        columnMenuOpen: open,
  ...
  const getColumnGroupHeaders = (params) => {
    ...
    headerToRender.forEach((depthInfo, depthIndex) => {
      columns.push(/* @__PURE__ */ (0, import_jsx_runtime149.jsx)(GridColumnHeaderRow, {
        style: {
...
//# sourceMappingURL=/build/routes/index-JROLMKRV.js.map
