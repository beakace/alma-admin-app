import {
  ...
  set,
  useForm
} from "/build/_shared/chunk-WDX7GFHY.js";
import {
  Box_default,
  MenuItem_default,
  Select_default,
  TextField_default
} from "/build/_shared/chunk-YJWUVHGS.js";
import {
  Button_default
...
var schema = create6().shape({
  wifeFirstName: create3().required("Imi\u0119 jest wymagane"),
  wifeLastName: create3().required("Nazwisko jest wymagane"),
  wifePhoneNumber: create4().required("Numer telefonu jest wymagany"),
  wifeEmail: create3().required("Email jest wymagany").email("Email jest nieprawid\u0142owy"),
  wifeBirthYear: create4().required("Rok urodzenia jest wymagany"),
  husbandFirstName: create3().required("Imi\u0119 jest wymagane"),
  husbandLastName: create3().required("Nazwisko jest wymagane"),
  husbandPhoneNumber: create4().required("Numer telefonu jest wymagany"),
  husbandEmail: create3().required("Email jest wymagany").email("Email jest nieprawid\u0142owy"),
  husbandBirthYear: create4().required("Rok urodzenia jest wymagany"),
  weddingYear: create4().required("Rok \u015Blubu jest wymagany"),
  city: create4().required("Miasto jest wymagane")
});
var Home = () => {
  const {
    register,
...
//# sourceMappingURL=/build/routes/create-55SHCR4A.js.map
